...
export function transformOdooBuilding(odooData: any): Building {
  return {
    ...
    manager_id: odooData.manager_id?.[0] || odooData.manager_id || undefined,
    manager_name: odooData.manager_id?.[1] || '',
...
export function transformOdooChargingSession(odooData: any): SessioneRicarica {
  return {
    ...
    parking_space_id: odooData.parking_space_id || 0,
    parking_space_name: odooData.parking_space_name || '',
